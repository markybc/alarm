            ...
            <ul class="layui-nav layui-nav-tree"  lay-filter="test">
                <li class="layui-nav-item layui-nav-itemed">
                    ...
                    <dl class="layui-nav-child">
                        ...
                        <dd class="layui-this"><a href="/alarm-api/alarm/listener/index">接收者列表</a></dd>
                    </dl>
                </li>
            </ul>
        </div>
...
<script>
    ...
    layui.use('table', function(){
        ...
        table.render({
            elem: '#test'
            ,url:'/alarm-api/alarm/list/listener'
            ,cellMinWidth: 80 //全局定义常规单元格的最小宽度，layui 2.2.1 新增
            ,cols: [[
                {field:'Id', width:80, title: 'ID'}
                ,{field:'AccessToken', title: '授权Token'}
                ,{field:'ChatId', title: '群组编号'}
                ,{field:'Sn', title: '备注'}
