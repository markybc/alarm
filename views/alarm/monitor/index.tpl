        ...
        <div class="layui-side-scroll">
            ...
            <ul class="layui-nav layui-nav-tree" lay-filter="test">
                <li class="layui-nav-item layui-nav-itemed">
                    ...
                    <dl class="layui-nav-child">
                        <dd><a href="/alarm-api/alarm/connection/index">数据库列表</a></dd>
                        <dd><a href="/alarm-api/alarm/topic/index">消息主题列表</a></dd>
                        <dd class="layui-this"><a href="/alarm-api/alarm/monitor/index">业务SQL监控</a></dd>
...
<script>
    ...
    layui.use('table', function () {
        ...
        table.render({
            elem: '#test'
            , url: '/alarm-api/alarm/monitor/list/sql'
            , cellMinWidth: 80 //全局定义常规单元格的最小宽度，layui 2.2.1 新增
            , cols: [[
                {field: 'Id', width: 80, title: 'ID'}
                , {field: 'Cron', width: 150, title: 'cron表达式'}
                , {field: 'Sql', title: '执行sql语句'}
                , {field: 'AliasName', width: 100, title: '数据库别名'}
                , {field: 'Status', width: 80, title: '状态'}
                , {field: 'DbId', width: 100, title: '数据库编号'}
                , {field: 'Note', title: '告警内容'}
                , {field: 'Sn', title: '消息主题'}
                , {field: 'ShowSql', width: 100, title: 'showSQL'}
                , {field: 'JobIsExits', width: 100, title: '已启动'}
                , {field: 'TaskId', width: 100, title: '任务ID'}
